      ...
      <div style={{ maxWidth:1200, margin:'0 auto', padding:'80px 32px' }}>
        <div className="site-iletisim-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1.4fr', gap:64, alignItems:'start' }}>
          ...
          <div>
            ...
            <h1 style={{ fontSize:'clamp(28px,4vw,44px)', fontWeight:800, letterSpacing:-1, color:'#fff', marginBottom:16, lineHeight:1.1 }}>Teklif İçin Bize Ulaşın</h1>
          ...
          <div style={{ background:'#0e0e1c', border:'1px solid rgba(255,255,255,.07)', borderRadius:20, padding:36 }}>
            {gonderildi ? (
              <div style={{ textAlign:'center', padding:'60px 0' }}>
                ...
                <h2 style={{ fontSize:22, fontWeight:800, color:'#fff', marginBottom:12 }}>Talebiniz Alındı!</h2>
              ...
              <>
                ...
                <button onClick={gonder} disabled={yukleniyor} style={{
                  width:'100%', padding:14, borderRadius:10, background:'#6366f1', color:'#fff',
