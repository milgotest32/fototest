...
export async function generateMetadata() {
  return getSeoMetadata('/referanslar')
}
  ...
  return (
    <div style={{ background: '#f8f8f6', minHeight: '100vh', width: '100%', color: '#1a1a2e', fontFamily: "'Inter',-apple-system,system-ui,sans-serif" }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '80px 32px' }}>
        ...
        <h1 style={{ fontSize: 'clamp(32px,5vw,52px)', fontWeight: 800, letterSpacing: -1.5, color: '#111118', marginBottom: 16, lineHeight: 1.1 }}>Güven Duyulan Markalar</h1>
