...
export default function Tahsilat() {
  ...
  const [donemGoster, setDonemGoster] = useState(true)
  ...
  return (
    <div className="page-wrap" >
      ...
      <div style={{ display:'flex', gap:12, alignItems:'flex-start', background:'var(--accent-soft)', border:'1px solid rgba(99,102,241,0.1)', borderRadius:12, padding:'14px 16px', marginBottom:20 }}>
        ...
        <p style={{ fontSize:13, color:'var(--text-dim)', lineHeight:1.7, margin:0 }}>Tahsilat ve Cari — Vade aşım takibi. "Tahsilat Al" butonuyla ödeme alın, bakiye otomatik güncellenir. 🕐 ikonuyla geçmiş tahsilatları görüntüleyin. Dönem analizi bölümünde aylık detayları inceleyin.</p>
      </div>
